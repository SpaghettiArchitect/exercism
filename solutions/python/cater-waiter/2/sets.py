...
def categorize_dish(dish_name, dish_ingredients: set):
    ...
    (VEGAN, VEGETARIAN, PALEO, KETO, or OMNIVORE). All dishes will "fit" into
    one of the categories imported from `sets_categories_data.py`
...
def tag_special_ingredients(dish):
    ...
    special note on the dish description. For the purposes of this exercise,
...
def singleton_ingredients(dishes: list[set], intersection: set):
    ...
    overlapping_ingredients = set()
    for dish in dishes:
        overlapping_ingredients = overlapping_ingredients ^ dish

    unique_ingredients = overlapping_ingredients - intersection
